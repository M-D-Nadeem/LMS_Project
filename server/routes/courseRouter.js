...
router.route("/")
.get(jwtAuth,authorizedRoles("ADMIN"),getAllCourses) //By this way we can give multiple methods(get,post,put..) in same route

router.post("/",jwtAuth,authorizedRoles("ADMIN"),upload.single("thumbnail") ,createCourse)

router.route('/:courseId')
.get(jwtAuth,authorizedRoles("ADMIN"),getLecturesByCourseId)
...
.get(jwtAuth,authorizedRoles("ADMIN"),deleteLectureToCourseById)
